...
export const Errors = {
    ...
    notFound: (entityName?: string, searchField = "id"): NotFoundException =>
    ...
    conflict: (uniqueField = "id"): ConflictException =>
    ...
    badRequest: (message = "Bad Request"): BadRequestException =>
        new BadRequestException({
            code: "BAD_REQUEST",
            statusCode: 400,
            message,
